...
import 'package:my_app/widgets/pop_up.dart';
...
class _EventListItemState extends State<EventListItem> {
  ...
  Future<void> toggleEvent(String eventId, bool hasUserJoined) async {
    ...
    checkIfEventIsFull(numberOfPlayersInEvent, numberOfAllowed,
        hasUserJoined);
  ...
  checkIfEventIsFull(int numberOfPlayersInEvent, int numberOfAllowed,
        bool hasUserJoined) {
