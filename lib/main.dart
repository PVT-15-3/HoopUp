...
import 'classes/bottom_nav_bar.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/list_events.dart': (context) => const JoinedEventsPage(showJoinedEvents : true),
          '/join_event_page.dart': (context) => const EventHandler(showJoinedEvents: false),
        },
      ),
    );
  }
